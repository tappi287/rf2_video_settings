...
from rf2settings.valve import messages

# NOTE: backwards compatability; remove soon(tm)
NoResponseError = rf2settings.valve.NoResponseError


class ServerQuerier(rf2settings.valve.BaseQuerier):
    ...
    def get_response(self):
        ...
        data = rf2settings.valve.BaseQuerier.get_response(self)
