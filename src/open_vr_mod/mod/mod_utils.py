...
from open_vr_mod.globals import get_data_dir
from open_vr_mod.mod import BaseModType
...
def get_mod(manifest, mod_type):
    ...
    :param dict manifest:
    :param int mod_type:
    :rtype: open_vr_mod.mod.base_mod.BaseMod
    """
    mod_type_class = getattr(open_vr_mod.mod, BaseModType.mod_types.get(mod_type))
...
def get_available_mods(manifest):
    ...
    :param dict manifest:
    :rtype: list[open_vr_mod.mod.base_mod.BaseMod]
    """
