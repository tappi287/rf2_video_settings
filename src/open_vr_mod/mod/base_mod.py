...
import open_vr_mod.cfg
from open_vr_mod.cfg import BaseModCfgType, BaseModSettings
from open_vr_mod.mod import BaseModType, update_mod_data_dirs, get_mod_version_from_dll
...
class BaseMod:
    ...
    DLL_NAME = open_vr_mod.globals.OPEN_VR_DLL
    ...
    def reset_settings(self) -> bool:
        try:
            ...
            settings_class = getattr(open_vr_mod.cfg, settings_class_name)
